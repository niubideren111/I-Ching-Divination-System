...
本項目是一個基於**周易（易經）** 傳統文化的開源占卜系統，實現了六爻起卦、變卦分析、陰陽五行等核心算法。項目旨在：

- 📚 為傳統文化愛好者提供學習工具
- 🔬 探索古典哲學與現代編程的結合
- 🧪 為學術研究提供可驗證的算法實現

> 🎯 **項目定位**：開源研究項目，僅供學習交流和文化傳播使用。
...
| 模組 | 功能說明 |
|------|----------|
| 🔮 **六爻起卦** | 支持傳統蓍草法、金錢卦等多種起卦方式 |
| 🔄 **變卦分析** | 自動計算動爻、變卦及本卦、互卦、變卦關係 |
| ☯ **陰陽五行** | 集成天干地支、五行生剋、刑沖合害分析 |
| 🌐 **網頁界面** | 純前端實現，無需後端伺服器即可運行 |
| 📱 **響應式設計** | 支持PC端和移動端訪問 |
| 🧠 **AI擴展接口** | 預留與LLM（ChatGPT等）集成的API結構 |
